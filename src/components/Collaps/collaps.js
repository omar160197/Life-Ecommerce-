...
import DeliveryMethod from '../rceipts/DeliveryMethod';
import ProfileOrdersDetails from '../../pages/receipts/profileOrderDetails';
...
export default function CustomizedAccordions({order,index}) {
